...
namespace abpGuidVsLongTest.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GProducts_GCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LProducts_LCategories_CategoryId",
                        column: x => x.CategoryId,
